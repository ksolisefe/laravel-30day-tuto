            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img src="https://www.evergladesfarmequipment.com/img/Everglades_Horiz_Logo_320.png"
                                alt="Your Company" />
                        </div>
                    ...
                    <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                        ...
                        <img src="https://reactormag.com/wp-content/uploads/2015/01/war-walker-Small.jpg" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
                    </button>
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                ...
                <div class="border-t border-white/10 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        <div class="shrink-0">
                            <img src="https://reactormag.com/wp-content/uploads/2015/01/war-walker-Small.jpg"
                                alt=""
                                class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
                        </div>
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Kevin Arriaga</div>
                            <div class="text-sm font-medium text-gray-400">kevin.arriaga@gmail.com</div>
                        </div>
                        <button type="button"
